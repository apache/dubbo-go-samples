...
var file_greet_proto_depIdxs = []int32{
	0, // 0: observability.GreetService.Greet:input_type -> observability.GreetRequest
	1, // 1: observability.GreetService.Greet:output_type -> observability.GreetResponse
