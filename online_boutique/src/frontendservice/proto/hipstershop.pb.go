...
type Money struct {
	...
	// If `units` is zero, `nanos` can be positive, ero, or negative.
...
const file_hipstershop_proto_rawDesc = "" +
	...
	"\tAdService\x12;\n" +
	"\x06GetAds\x12\x16.hipstershop.AdRequest\x1a\x17.hipstershop.AdResponse\"\x00B\x0eZ\f./proto;demob\x06proto3"
