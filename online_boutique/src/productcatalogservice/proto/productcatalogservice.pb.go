...
const file_productcatalogservice_proto_rawDesc = "" +
	"\n" +
	"\x1bproductcatalogservice.proto\x12\vhipstershop\"X\n" +
	"\x05Money\x12#\n" +
...
var (
	...
	file_productcatalogservice_proto_rawDescData []byte
)

func file_productcatalogservice_proto_rawDescGZIP() []byte {
	file_productcatalogservice_proto_rawDescOnce.Do(func() {
		file_productcatalogservice_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_productcatalogservice_proto_rawDesc), len(file_productcatalogservice_proto_rawDesc)))
	})
...
var file_productcatalogservice_proto_goTypes = []any{
...
func file_productcatalogservice_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_productcatalogservice_proto_rawDesc), len(file_productcatalogservice_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
