...
const (
	...
	EmailServiceSendOrderConfirmationProcedure = "/email.EmailService/SendOrderConfirmation"
)
...
// EmailService is a client for the email.EmailService service.
...
// NewEmailService constructs a client for the email.EmailService service.
func NewEmailService(cli *client.Client, opts ...client.ReferenceOption) (EmailService, error) {
	conn, err := cli.DialWithInfo("email.EmailService", &EmailService_ClientInfo, opts...)
	if err != nil {
		return nil, err
	}
...
var EmailService_ClientInfo = client.ClientInfo{
	InterfaceName: "email.EmailService",
