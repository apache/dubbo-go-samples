...
import (
	...
	"github.com/apache/dubbo-go-samples/online_boutique_demo/currencyservice/config"
...
func main() {
	...
	if err := hipstershop.RegisterCurrencyServiceHandler(srv, &handler.CurrencyService{}); err != nil {
		panic(err)
	}
