...
import (
	dubbo3pb "github.com/apache/dubbo-go-samples/general/triple/pb/grpc/protobuf/triple"
	grpcpb   "github.com/apache/dubbo-go-samples/general/triple/pb/grpc/server/dubbogo-server/tests/integration/grpc_test_proto"
)
