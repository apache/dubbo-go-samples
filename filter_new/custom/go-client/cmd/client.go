...
func main() {
	...
	resp, err := svc.Greet(context.Background(), &greet.GreetRequest{Name: "clientFilter"})
	if err != nil {
		logger.Error(err)
	}
	logger.Infof("clientFilter Greet response: %s", resp.Greeting)
}
