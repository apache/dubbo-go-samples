...
require (
	...
	github.com/apache/dubbo-go-samples/compatibility/api v0.0.0-00010101000000-000000000000
	github.com/dubbogo/gost v1.14.1
)

replace github.com/apache/dubbo-go-samples/compatibility/api => ../../api
