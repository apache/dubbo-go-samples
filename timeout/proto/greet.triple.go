...
type GreetService interface {
	...
	GreetTimeout(ctx context.Context, req *GreetRequest, opts ...client.CallOption) (*GreetResponse, error)
}
...
func (c *GreetServiceImpl) GreetTimeout(ctx context.Context, req *GreetRequest, opts ...client.CallOption) (*GreetResponse, error) {
	resp := new(GreetResponse)
	if err := c.conn.CallUnary(ctx, []interface{}{req}, resp, "GreetTimeout", opts...); err != nil {
		return nil, err
	}
	return resp, nil
}
...
type GreetServiceHandler interface {
	...
	GreetTimeout(context.Context, *GreetRequest) (*GreetResponse, error)
}
