...
const file_greet_proto_rawDesc = "" +
	...
	"\bgreeting\x18\x01 \x01(\tR\bgreeting2\x9f\x02\n" +
	"\x14SentinelGreetService\x124\n" +
	"\x05Greet\x12\x13.greet.GreetRequest\x1a\x14.greet.GreetResponse\"\x00\x12E\n" +
	"\x16GreetWithChanceOfError\x12\x13.greet.GreetRequest\x1a\x14.greet.GreetResponse\"\x00\x12@\n" +
	"\x11GreetWithQPSLimit\x12\x13.greet.GreetRequest\x1a\x14.greet.GreetResponse\"\x00\x12H\n" +
	"\x19GreetWithConcurrencyLimit\x12\x13.greet.GreetRequest\x1a\x14.greet.GreetResponse\"\x00B@Z>github.com/apache/dubbo-go-samples/filter/proto/sentinel;greetb\x06proto3"
