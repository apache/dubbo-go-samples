...
const file_greet_proto_rawDesc = "" +
	...
	"\bgreeting\x18\x01 \x01(\tR\bgreeting2\x7f\n" +
	"\fGreetService\x124\n" +
	"\x05Greet\x12\x13.greet.GreetRequest\x1a\x14.greet.GreetResponse\"\x00\x129\n" +
	"\n" +
	"GreetRetry\x12\x13.greet.GreetRequest\x1a\x14.greet.GreetResponse\"\x00B6Z4github.com/apache/dubbo-go-samples/retry/proto;greetb\x06proto3"
