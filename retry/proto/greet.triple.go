...
const (
	...
	// GreetServiceGreetRetryProcedure is the fully-qualified name of the GreetService's GreetRetry RPC.
	GreetServiceGreetRetryProcedure = "/greet.GreetService/GreetRetry"
)
...
type GreetService interface {
	...
	GreetRetry(ctx context.Context, req *GreetRequest, opts ...client.CallOption) (*GreetResponse, error)
}
...
func (c *GreetServiceImpl) GreetRetry(ctx context.Context, req *GreetRequest, opts ...client.CallOption) (*GreetResponse, error) {
	resp := new(GreetResponse)
	if err := c.conn.CallUnary(ctx, []interface{}{req}, resp, "GreetRetry", opts...); err != nil {
		return nil, err
	}
	return resp, nil
}
...
var GreetService_ClientInfo = client.ClientInfo{
	...
	MethodNames:   []string{"Greet", "GreetRetry"},
...
type GreetServiceHandler interface {
	...
	GreetRetry(context.Context, *GreetRequest) (*GreetResponse, error)
}
...
var GreetService_ServiceInfo = server.ServiceInfo{
	...
	Methods: []server.MethodInfo{
		...
		},
		{
			...
			MethodFunc: func(ctx context.Context, args []interface{}, handler interface{}) (interface{}, error) {
				req := args[0].(*GreetRequest)
				res, err := handler.(GreetServiceHandler).GreetRetry(ctx, req)
				if err != nil {
					return nil, err
				}
				return triple_protocol.NewResponse(res), nil
