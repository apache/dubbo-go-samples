...
public class Consumer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        startUserProviderConsumerService();
    }

    private static void startUserProviderConsumerService() {
        try {
            User user = userProvider.GetUser("A003");
            System.out.println("get reponse from rpc server:" + user);
        } catch (Throwable e) {
