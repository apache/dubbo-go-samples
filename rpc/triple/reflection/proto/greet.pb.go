...
const file_greet_proto_rawDesc = "" +
	...
	"\fGreetService\x124\n" +
	"\x05Greet\x12\x13.greet.GreetRequest\x1a\x14.greet.GreetResponse\"\x00BFZDgithub.com/apache/dubbo-go-samples/rpc/triple/reflection/proto;greetb\x06proto3"
