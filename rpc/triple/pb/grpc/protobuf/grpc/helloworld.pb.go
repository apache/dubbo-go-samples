...
var file_helloworld_proto_rawDesc = []byte{
	...
	0x75, 0x62, 0x62, 0x6f, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x22, 0x22, 0x0a, 0x0c, 0x48, 0x65, 0x6c,
	...
	0x2e, 0x64, 0x75, 0x62, 0x62, 0x6f, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x48, 0x65, 0x6c, 0x6c,
	0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1b, 0x2e, 0x6f, 0x72, 0x67, 0x2e, 0x61,
	0x70, 0x61, 0x63, 0x68, 0x65, 0x2e, 0x64, 0x75, 0x62, 0x62, 0x6f, 0x2e, 0x67, 0x72, 0x70, 0x63,
	...
	0x61, 0x70, 0x61, 0x63, 0x68, 0x65, 0x2e, 0x64, 0x75, 0x62, 0x62, 0x6f, 0x2e, 0x67, 0x72, 0x70,
	0x63, 0x2e, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1b,
	0x2e, 0x6f, 0x72, 0x67, 0x2e, 0x61, 0x70, 0x61, 0x63, 0x68, 0x65, 0x2e, 0x64, 0x75, 0x62, 0x62,
	0x6f, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x22, 0x00, 0x28, 0x01, 0x30,
...
var file_helloworld_proto_goTypes = []interface{}{
	(*HelloRequest)(nil), // 0: org.apache.dubbo.grpc.HelloRequest
	(*User)(nil),         // 1: org.apache.dubbo.grpc.User
}
var file_helloworld_proto_depIdxs = []int32{
	0, // 0: org.apache.dubbo.grpc.Greeter.SayHello:input_type -> org.apache.dubbo.grpc.HelloRequest
	0, // 1: org.apache.dubbo.grpc.Greeter.SayHelloStream:input_type -> org.apache.dubbo.grpc.HelloRequest
	1, // 2: org.apache.dubbo.grpc.Greeter.SayHello:output_type -> org.apache.dubbo.grpc.User
	1, // 3: org.apache.dubbo.grpc.Greeter.SayHelloStream:output_type -> org.apache.dubbo.grpc.User
...
func (c *greeterClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
	err := c.cc.Invoke(ctx, "/org.apache.dubbo.grpc.Greeter/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *greeterClient) SayHelloStream(ctx context.Context, opts ...grpc.CallOption) (Greeter_SayHelloStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Greeter_serviceDesc.Streams[0], "/org.apache.dubbo.grpc.Greeter/SayHelloStream", opts...)
	if err != nil {
		return nil, err
	}
...
func _Greeter_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/org.apache.dubbo.grpc.Greeter/SayHello",
	}
...
var _Greeter_serviceDesc = grpc.ServiceDesc{
	ServiceName: "org.apache.dubbo.grpc.Greeter",
