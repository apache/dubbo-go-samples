...
import (
	triple "github.com/apache/dubbo-go-samples/rpc/triple/pb/grpc/protobuf/triple"
)

type GreeterProvider struct {
	*triple.GreeterProviderBase
}

func NewGreeterProvider() *GreeterProvider {
	return &GreeterProvider{
		GreeterProviderBase: &triple.GreeterProviderBase{},
	}
}

func (s *GreeterProvider) SayHelloStream(svr triple.Greeter_SayHelloStreamServer) error {
	c, err := svr.Recv()
	if err != nil {
		return err
	}
...
func (s *GreeterProvider) SayHello(ctx context.Context, in *triple.HelloRequest) (*triple.User, error) {
	...
	return &triple.User{Name: "Hello " + in.Name, Id: "12345", Age: 21}, nil
}
