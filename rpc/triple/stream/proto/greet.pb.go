...
const file_greet_proto_rawDesc = "" +
	...
	"\bgreeting\x18\x01 \x01(\tR\bgreeting2\xc8\x02\n" +
	"\fGreetService\x124\n" +
	"\x05Greet\x12\x13.greet.GreetRequest\x1a\x14.greet.GreetResponse\"\x00\x12J\n" +
	"\vGreetStream\x12\x19.greet.GreetStreamRequest\x1a\x1a.greet.GreetStreamResponse\"\x00(\x010\x01\x12Z\n" +
	"\x11GreetClientStream\x12\x1f.greet.GreetClientStreamRequest\x1a .greet.GreetClientStreamResponse\"\x00(\x01\x12Z\n" +
	"\x11GreetServerStream\x12\x1f.greet.GreetServerStreamRequest\x1a .greet.GreetServerStreamResponse\"\x000\x01BBZ@github.com/apache/dubbo-go-samples/rpc/triple/stream/proto;greetb\x06proto3"
