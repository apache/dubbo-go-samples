...
const file_proto_greet_greet_proto_rawDesc = "" +
	...
	"\x11GreetServerStream\x12\x1f.greet.GreetServerStreamRequest\x1a .greet.GreetServerStreamResponse\"\x000\x01\x12Z\n" +
	"\x11GreetClientStream\x12\x1f.greet.GreetClientStreamRequest\x1a .greet.GreetClientStreamResponse\"\x00(\x01\x12V\n" +
...
var file_proto_greet_greet_proto_depIdxs = []int32{
	...
	6, // 3: greet.GreetService.GreetBidiStream:input_type -> greet.GreetBidiStreamRequest
	1, // 4: greet.GreetService.Greet:output_type -> greet.GreetResponse
	3, // 5: greet.GreetService.GreetServerStream:output_type -> greet.GreetServerStreamResponse
	5, // 6: greet.GreetService.GreetClientStream:output_type -> greet.GreetClientStreamResponse
	7, // 7: greet.GreetService.GreetBidiStream:output_type -> greet.GreetBidiStreamResponse
